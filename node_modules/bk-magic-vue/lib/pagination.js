(function (global, factory) {
	...
	var __vue_render__$3 = function __vue_render__() {
	  ...
	  return _c('div', {
	    ...
	    }, [_vm._v(_vm._s(option.name))]), _c('i', {
	...
	var script$6 = {
	  name: 'bk-option',
	  components: {
	    'bk-checkbox': __vue_component__$5
	  },
	  props: {
	    id: {
	      type: [String, Number],
	...
	var script$8 = {
	  ...
	  computed: {
	    ...
	    scrollEndLoading: function scrollEndLoading() {
	      return _extends({
	        isLoading: false,
	        text: '加载中',
	        size: 'mini',
	  ...
	  watch: {
	    ...
	    focus: function focus(_focus) {
	      ...
	      this.$nextTick(function () {
	        ...
	        if (_focus) {
	          _this.showVirtualScroll();
	          if (_this.enableScrollLoad) _this.handleScroll();
	        }
	      });
	    },
	    dropdownActive: function dropdownActive() {
	  ...
	  methods: {
	    ...
	    ensureSearch: function ensureSearch() {
	      ...
	      if (option && keys$1(option).length !== 0) {
	    ...
	    handleScroll: function handleScroll() {
	      ...
	      this.optionList.onscroll = debounce$1(this.listenScroll, 300, this.optionList);
	    },
	    listenScroll: function listenScroll(e, optionList) {
	...
	var script$b = {
	  name: 'bk-pagination',
	  components: {
	    bkSelect: __vue_component__$8,
	    bkInput: __vue_component__$9,
	    bkOption: __vue_component__$6,
	    paginationSelectionCount: __vue_component__$a,
	    paginationTotalCount: __vue_component__$b,
	    SmallJump: __vue_component__$c
	  },
	  mixins: [locale.mixin],
	  props: {
	    popoverOptions: {
	...
	setInstaller(__vue_component__$d);
