(function (global, factory) {
	...
	var script$4 = {
	  ...
	  computed: {
	    ...
	    dropdownContentWidth: function dropdownContentWidth() {
	    ...
	    dropdownContentStyle: function dropdownContentStyle() {
	      var maxWidth = /^\d+$/.test(this.maxWidth) ? "".concat(this.maxWidth, "px") : this.maxWidth;
	      var width = this.dropdownContentWidth + 'px';
	      return {
	        maxWidth: maxWidth,
	        width: width,
	        overflowX: 'auto'
	    ...
	    dropdownOptionsStyle: function dropdownOptionsStyle() {
	      return {
	  ...
	  created: function created() {
	    ...
	    this.$on('on-cascade-click', function () {
	      _this2.handleScrollToRight();
	    });
	  },
	  mounted: function mounted() {
	    var _this3 = this;
	...
	var __vue_render__$4 = function __vue_render__() {
	  ...
	  return _c('div', {
	    ...
	    style: _vm.dropdownContentStyle,
	    attrs: {
	      "slot": "content"
	    },
	    slot: "content"
