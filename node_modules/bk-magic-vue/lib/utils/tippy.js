(function (global, factory) {
	...
	var _extends = assign$1 || function (target) {
	...
	var Popper = function () {
	  function Popper(reference, popper) {
	    ...
	    keys$1(_extends({}, Popper.Defaults.modifiers, options.modifiers)).forEach(function (name) {
	...
	exports.getValidTippyProps = getValidTippyProps;
